...
//    }
    ...
    extern "C" JNIEXPORT jobject JNICALL
    Java_com_jap_twstockinformation_StockUtilV2_getMapNumName(JNIEnv *env, jobject /* this */,
                                                              jstring cacert_java) {
    ...
    Java_com_jap_twstockinformation_StockUtilV2_getHtmlStringPrice(JNIEnv *env, jobject /* this */,
                                                                   jstring cacert_java) {
        const std::string cacert = curlssl::jni::Convert<std::string>::from(env, cacert_java);
        jstring html_string;
    ...
    extern "C" JNIEXPORT jstring JNICALL
    Java_com_jap_twstockinformation_StockUtilV2_getJsonStringFundamental(JNIEnv *env,
                                                                         jobject /* this */,
                                                                         jstring cacert_java) {
        const std::string cacert = curlssl::jni::Convert<std::string>::from(env, cacert_java);
        jstring html_string;
    ...
    extern "C" JNIEXPORT jstring JNICALL
    Java_com_jap_twstockinformation_StockUtilV2_getHtmlStringIncome(JNIEnv *env, jobject /* this */,
                                                                    jstring cacert_java) {
        const std::string cacert = curlssl::jni::Convert<std::string>::from(env, cacert_java);
        jstring html_string;
    ...
    extern "C" JNIEXPORT jstring JNICALL
    Java_com_jap_twstockinformation_StockUtilV2_getHtmlStringInstitutionalInvestorsRatio(JNIEnv *env,
                                                                                         jobject /* this */,
                                                                                         jstring cacert_java) {
        const std::string cacert = curlssl::jni::Convert<std::string>::from(env, cacert_java);
        jstring html_string;
